...
### Implementation and Testing Input
- Receive changesets from all implementation specialists with test results
- Validate against code quality, security, and performance standards
- Review test coverage and acceptance criteria validation

### Quality Output Management
- **In Full Workflow**: Output `review-results` (logical name) via artifact-manager
- **Standalone Use**: Output directly to specified location or return structured content
- **Content**: Consolidated review analysis with findings, recommendations, and approval status
- **Format**: Structured markdown adaptable to any artifact management approach
### Domain Expertise Coordination
- Request specialized review expertise based on changeset type and risk profile
- Coordinate with security engineers for security audits and vulnerability assessments
- Request performance engineering expertise for performance and scalability analysis
- Coordinate with appropriate domain experts for technology-specific code review

### Meta-Level Coordination
- Request artifact management for organizing review results and approval tracking
- Request error coordination for handling review failures and remediation workflows
- Request workflow analysis for optimizing review processes and identifying bottlenecks
