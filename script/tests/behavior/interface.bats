...
# Focus: Test our script interfaces, entry points, behavioral contracts, and UI components
# Combines UI component testing with interface behavior validation

# Load helpers using correct relative path from behavior directory
load "../helpers/base"
load "../helpers/mocks"
...
setup() {
    ...
    # Source the UI module directly for UI testing
    source "$DOTFILES_PARENT_DIR/script/core/ui" || true
}
...
# =============================================================================
# UI COMPONENT TESTS - Version Display and Interface Elements
# =============================================================================
...
# =============================================================================
# SCRIPT INTERFACE TESTS - Entry Points and Behavioral Contracts
# =============================================================================
